        ...
        <div className={` flex flex-col items-center justify-center shadow
            ...
            <div className="flex flex-row items-center md:gap-4">
                <img src="https://cdn.pixabay.com/photo/2024/05/31/18/54/meme-8801100_1280.png"
                    className="w-24 h-24 md:w-32 md:h-32 rounded-full border-2 border-zinc-300"/>
                <section className="flex flex-col">
                    <p className="text-xl md:text-2xl font-bold text-zinc-800 dark:text-zinc-200 mx-2 p-2 ">Eyosyas Guush</p>
